...
namespace Selkie.WPF.Converters.Tests.NUnit
{
    ...
    internal sealed class RacetrackPathUTurnToFiguresConverterTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        private RacetrackPathUTurnToFiguresConverter m_Converter;
        ...
        private ITurnCircleArcSegment m_MiddleSegment;
        ...
        [Test]
        public void ConvertForEndSegmentIsNullTest()
        {
            var path = Substitute.For <IPath>();
            path.Segments.Returns(new[]
                                  {
                                      m_StartSegment,
                                      m_MiddleSegment,
                                      null
        ...
        [Test]
        public void ConvertForMiddleSegmentIsNullTest()
        {
            var path = Substitute.For <IPath>();
            path.Segments.Returns(new[]
                                  {
        ...
        [Test]
        public void ConvertForPathUnknowTest()
        {
        ...
        [Test]
        public void ConvertForStartSegmentIsNullTest()
        {
            var path = Substitute.For <IPath>();
            path.Segments.Returns(new[]
                                  {
        ...
        [Test]
        public void ConvertForWrongPathLengthTest()
        {
            var path = Substitute.For <IPath>();
            path.Segments.Returns(new[]
                                  {
        ...
        {
            PathFigureCollection collection = m_Converter.CreateFigures(m_StartSegment,
                                                                        m_MiddleSegment,
                                                                        m_EndSegment);
        ...
        {
            PathFigure figures = m_Converter.CreateFigures(m_StartSegment,
                                                           m_MiddleSegment,
                                                           m_EndSegment).First();
        ...
        {
            PathFigure pathFigure = m_Converter.CreateFigures(m_StartSegment,
                                                              m_MiddleSegment,
                                                              m_EndSegment).First();
