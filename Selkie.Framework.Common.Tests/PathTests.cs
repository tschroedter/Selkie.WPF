...
namespace Selkie.Framework.Common.Tests
{
    [TestFixture]
    ...
    internal sealed class PathTests
    {
        ...
        internal sealed class CommonTests
        {
            ...
            [Test]
            public void Constructor_ReturnsInstance_ForPolyline()
            {
                // Arrange
                ...
                polyline.StartPoint.Returns(startPoint);
                polyline.EndPoint.Returns(endPoint);
                polyline.IsUnknown.Returns(false);
            ...
            [Test]
            public void Constructor_ReturnsInstance_ForSegments()
            {
                // Arrange
                // Act
            ...
            [Test]
            public void Distance_ReturnsDistance_ForPolyline()
            {
                // Arrange
                var polyline = Substitute.For <IPolyline>();
                polyline.Length.Returns(123.0);

                // Act
                var sut = new Path(polyline);

                // Assert
                NUnitHelper.AssertIsEquivalent(123.0,
                                               sut.Distance.Length);
            }
